...
// Optimized background blobs - removed unnecessary memoization
...
// Optimized hero section - removed unnecessary memoization
const HeroSection = () => (
...
// Optimized how it works section - removed unnecessary memoization
...
export default function Home() {
  return (
    <>
      {/* Consolidated Structured Data for better performance */}
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            generateWebsiteStructuredData(),
            generateFAQStructuredData(FAQ_DATA)
          ])
        }}
      />
